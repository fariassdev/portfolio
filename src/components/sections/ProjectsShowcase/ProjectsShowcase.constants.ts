...
export const LAPTOP_SCALE = 50;
export const CAMERA_Z = 750;
export const MOBILE_BREAKPOINT = 696;

// Animation Configuration
export const BASE_LAPTOP_ROTATION_X = Math.PI / 20;
export const MAX_LAPTOP_ROTATION_Y = Math.PI / 12;
export const PARALLAX_X_FACTOR = 0.05;
export const PARALLAX_Y_FACTOR = 0.025;
export const DESKTOP_SLIDE_FACTOR = 0.25;
